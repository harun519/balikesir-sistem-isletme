      ...
      <div className="mobilePage">
        ...
        <div className="mobileContent">
          ...
          <section className="mobileGrid">
            <a className="mobileCard blueCard" href="https://balikesir-trafo-degisimi.vercel.app">
              ...
              <span className="version blueVersion">v10.0</span>
              <p>Trafo değişim kayıtları,<br />raporlar ve arşiv</p>
              <div className="mobileButton blueButton">→ Uygulamaya Git</div>
            </a>

            <a className="mobileCard greenCard" href="https://scada-saha-kontrol-vercel.vercel.app">
              ...
              <span className="version greenVersion">v7.7.3</span>
              <p>SCADA istasyon kontrolü,<br />uygunsuzluklar ve raporlar</p>
              <div className="mobileButton greenButton">→ Uygulamaya Git</div>
            </a>

            <a className="mobileCard purpleCard" href="https://goruntulu-teyit-v1.vercel.app">
              ...
              <span className="version purpleVersion">v125</span>
            ...
            <article className="mobileCard orangeCard">
              ...
              <span className="version orangeVersion">Yakında</span>
          ...
          <section className="mobileUpdates">
            ...
            <div><b>Trafo Değişimi</b><span className="mini blueVersion">v10.0</span><time>09.09.2026</time></div>
            <div><b>SCADA Saha Kontrol</b><span className="mini greenVersion">v7.7.3</span><time>09.09.2026</time></div>
            <div><b>Görüntülü Teyit</b><span className="mini purpleVersion">v125</span><time>09.09.2026</time></div>
          </section>
      ...
      <style jsx>{`
        ...
        @media (orientation: portrait) and (max-width: 700px) {
          ...
          .mobileBg {
            position: fixed;
            inset: -30px;
            background: url("/portal-final-kompakt.png") center / cover no-repeat;
            filter: blur(18px) brightness(.48) saturate(.9);
          ...
          .mobileShade {
            ...
            inset: 0;
            background:
              linear-gradient(180deg, rgba(3,14,28,.20), rgba(3,14,28,.58)),
              radial-gradient(circle at 50% 5%, rgba(18,80,135,.22), transparent 40%);
          }
          ...
          .mobileCard {
            ...
            border-radius: 16px;
            background: linear-gradient(180deg, rgba(19,33,52,.90), rgba(7,18,33,.94));
          ...
          .mobileIcon :global(svg) { width: 25px; height: 25px; }
          .blueIcon { background:#0878ff; color:#ffd43b; }
          .greenIcon { background:#08bf89; color:#fff; }
          .purpleIcon { background:linear-gradient(135deg,#7436ff,#a400ff); color:#fff; }
          .orangeIcon { background:linear-gradient(135deg,#ff7100,#d95100); color:#fff; }
          ...
          .blueVersion { background:#0878ff; }
          .greenVersion { background:#08b982; }
          .purpleVersion { background:#8b20f5; }
          .orangeVersion { background:#f26500; }
          ...
          .blueButton { background:#0878ff; }
          .greenButton { background:#08bd86; }
          .purpleButton { background:linear-gradient(90deg,#7639ff,#a100ef); }
          .orangeButton { background:linear-gradient(90deg,#c74c00,#a83f00); }

          .mobileStatus, .mobileUpdates {
            border: 1px solid rgba(255,255,255,.15);
            border-radius: 15px;
            background: rgba(7,20,37,.91);
          ...
          .mobileUpdates b { font-size:10.5px; }
          .mobileUpdates .mini {
            margin:0;
            min-width:44px;
            padding:4px 6px;
        ...
        /* Çok dar telefonlarda tek sütuna düşmesin; 2x2 kompakt kalsın */
        @media (orientation: portrait) and (max-width: 360px) {
          .mobileContent { padding-left:8px; padding-right:8px; }
          .mobileGrid { gap:7px; }
          .mobileCard { padding-left:6px; padding-right:6px; }
          .mobileCard h2 { font-size:12.5px; }
          .mobileCard p { font-size:9.5px; }
          .mobileButton { font-size:9.5px; }
        }
      `}</style>
    </main>
  );
