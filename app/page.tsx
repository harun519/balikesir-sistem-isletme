...
import DuyuruOzet from "./DuyuruOzet";
...
export default function Home(){return <main className="portal">
  ...
  <style jsx>{`
    ...
    .grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.card{min-height:300px;padding:28px 22px 20px;border:1px solid rgba(154,184,215,.22);border-radius:22px;background:linear-gradient(180deg,rgba(21,42,67,.94),rgba(7,22,39,.97));box-shadow:0 18px 45px rgba(0,0,0,.32);color:#fff;text-decoration:none;display:flex;flex-direction:column;align-items:center;text-align:center;transition:transform .18s ease,box-shadow .18s ease}.card:not(.disabled):hover{transform:translateY(-7px) scale(1.025);box-shadow:0 28px 60px rgba(0,0,0,.42)}.icon{width:68px;height:68px;border-radius:50%;display:grid;place-items:center;font-size:31px;margin-bottom:22px;box-shadow:0 10px 24px rgba(0,0,0,.24)}.card h2{margin:0;min-height:50px;display:flex;align-items:center;justify-content:center;font-size:21px;font-weight:900}.card p{margin:14px 0 20px;font-size:12px;line-height:1.55;color:#cbd8e7}.btn{width:100%;height:45px;margin-top:auto;border-radius:11px;display:grid;place-items:center;font-size:13px;font-weight:900}.blue .icon,.blue .btn{background:#0b82ff}.blue .icon{color:#ffd43b}.green .icon,.green .btn{background:#10bf8a}.purple .icon,.purple .btn{background:linear-gradient(135deg,#7930ff,#aa00ef)}.orange .icon,.orange .btn{background:linear-gradient(135deg,#ff7100,#c44b00)}.disabled{opacity:.8;cursor:default}
    .bottom{width:100%;margin:18px auto 0;display:grid;grid-template-columns:1fr 1fr 1fr 1.05fr;border:1px solid rgba(154,184,215,.18);border-radius:18px;background:linear-gradient(180deg,rgba(20,39,61,.94),rgba(7,20,35,.97));box-shadow:0 16px 38px rgba(0,0,0,.30);overflow:hidden}.status{min-height:105px;padding:20px 16px;display:flex;align-items:center;gap:12px;border-right:1px solid rgba(255,255,255,.07)}.statusLink{color:#fff;text-decoration:none}.check{width:48px;height:48px;flex:0 0 48px;border-radius:50%;display:grid;place-items:center;background:#10bf8a;font-size:27px;font-weight:900}.usersCheck{background:#2563eb;font-size:21px}.recoveryCheck{background:#e8590c;font-size:22px}.status h3{margin:0 0 7px;font-size:14px}.status p{margin:0;font-size:10px;color:#cbd8e7}footer{text-align:center;padding-top:14px;font-size:9px;color:#d6e2ef}
    @media(max-width:900px){.grid{grid-template-columns:repeat(2,minmax(0,1fr))}.bottom{grid-template-columns:repeat(2,1fr)}}@media(max-width:700px){.portal{background-attachment:scroll}.content{width:100%;padding:24px 10px 20px;justify-content:flex-start}.grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.card{min-height:236px;padding:14px 8px 10px;border-radius:15px}.icon{width:46px;height:46px;font-size:22px;margin-bottom:10px}.card h2{min-height:38px;font-size:13px}.card p{font-size:9.3px;margin:9px 0 10px}.btn{height:34px;font-size:9.8px}.bottom{grid-template-columns:1fr}.status{border-right:0;border-bottom:1px solid rgba(255,255,255,.07);min-height:82px;padding:13px 16px}}
  `}</style>
</main>}
