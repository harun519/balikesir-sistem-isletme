...
const CSS=`
*{box-sizing:border-box}body{margin:0;background:#071426;font-family:Inter,Arial,Helvetica,sans-serif}.page{min-height:100vh;color:#fff;background:radial-gradient(circle at 50% -15%,#173d61,#071426 58%);padding:30px 16px 55px}.wrap{width:min(1240px,100%);margin:auto}.top{display:flex;justify-content:space-between;align-items:center;gap:20px;margin-bottom:18px}.eyebrow{font-size:10px;font-weight:900;letter-spacing:3px;color:#86a4c0}.top h1{font-size:34px;margin:5px 0}.top p{margin:0;color:#a8bfd3;font-size:12px}.top>a{color:#fff;text-decoration:none;border:1px solid #ffffff20;background:#ffffff0c;padding:10px 14px;border-radius:11px;font-size:11px;font-weight:900}.statusGrid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.status,.connectBox,.createPanel,.appPanel,.legend{border:1px solid #ffffff14;background:linear-gradient(180deg,#112b45,#0a1d30);box-shadow:0 14px 36px #0003}.status{border-radius:14px;padding:13px;display:flex;align-items:center;gap:10px}.statusIcon{width:42px;height:42px;border-radius:11px;background:#ffffff0d;display:grid;place-items:center;font-size:20px}.status>div:nth-child(2){flex:1}.status b,.status span{display:block}.status b{font-size:12px}.status span{margin-top:4px;font-size:9px;color:#8fa8c0}.status em,.appHead em{font-style:normal;font-size:7px;font-weight:900;padding:5px 8px;border-radius:20px}.ok{background:#064e3b;color:#86efac}.off{background:#3f4858;color:#cbd5e1}.connections{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px}.connectBox{border-radius:14px;padding:12px;display:grid;grid-template-columns:1.2fr 1fr 1fr auto;gap:8px;align-items:center}.connectBox b,.connectBox span{display:block}.connectBox b{font-size:14px}.connectBox span{font-size:11px;color:#9db4c9;margin-top:4px;line-height:1.35}.connectBox input,.identity input,.roleBox select,.userRow select{height:38px;border:1px solid #ffffff1c;background:#081b2d;color:#fff;border-radius:9px;padding:0 10px;outline:0}.connectBox button{height:38px;border:0;border-radius:9px;background:#2563eb;color:#fff;font-weight:900;padding:0 14px;cursor:pointer}.connectBox.crm button{background:#0891b2}
.connectBox.connected{grid-template-columns:auto 1fr auto;background:linear-gradient(180deg,#0b3d36,#0a302d);border-color:#1c8a72}.connectBox.connected.crm{background:linear-gradient(180deg,#0b3541,#0a2a35);border-color:#1389a6}.connectBox.connected strong{font-size:11px;letter-spacing:1px;color:#86efac;background:#065f46;padding:8px 11px;border-radius:999px}.connectedMark{width:40px;height:40px;border-radius:12px;display:grid;place-items:center;background:#10b981;color:#fff;font-size:22px;font-weight:900}
.privacy{margin:10px 2px 0;color:#8fa8c0;font-size:11px}.alert{margin-top:10px;padding:11px 13px;border-radius:11px;font-size:10px;font-weight:800}.alert.good{background:#064e3b88;color:#a7f3d0;border:1px solid #34d39944}.alert.bad{background:#7f1d1d88;color:#fecaca;border:1px solid #fb718544}.createPanel{margin-top:14px;border-radius:18px;padding:18px}.panelTitle{display:flex;align-items:center;justify-content:space-between}.panelTitle small{font-size:10px;letter-spacing:2px;color:#60a5fa;font-weight:900}.panelTitle h2{font-size:20px;margin:4px 0}.panelTitle p{font-size:12px;color:#9db4c9;margin:0}.shield{width:46px;height:46px;border-radius:13px;display:grid;place-items:center;background:#2563eb;font-size:22px}.identity{display:grid;grid-template-columns:1fr 1.3fr 1fr;gap:9px;margin-top:16px}.identity label{font-size:12px;font-weight:900;color:#c0d0df}.identity input{display:block;width:100%;margin-top:6px}.roles{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin-top:12px}.roleBox{border:1px solid #ffffff12;border-top:3px solid var(--tone);border-radius:13px;background:#ffffff06;padding:11px}.roleBox>span,.roleBox>b{display:block}.roleBox>span{font-size:21px}.roleBox>b{font-size:13px;margin:8px 0 10px}.roleBox select{width:100%;height:34px}.createBtn{width:100%;height:44px;margin-top:12px;border:0;border-radius:11px;background:linear-gradient(90deg,#1677e8,#0758b8);color:#fff;font-weight:900;cursor:pointer}.createBtn:disabled,.connectBox button:disabled{opacity:.55}.legend{margin-top:10px;border-radius:13px;padding:13px 15px;display:flex;align-items:center;gap:18px;flex-wrap:wrap;font-size:12px;color:#c0d0df}.legend>b{color:#fff}.legend span{display:flex;align-items:center;gap:5px}.legend i{width:8px;height:8px;border-radius:50%}.legend .a{background:#ef4444}.legend .e{background:#f59e0b}.legend .v{background:#22c55e}.legend .n{background:#64748b}.apps{display:grid;grid-template-columns:1.15fr .85fr .85fr;gap:10px;margin-top:10px}.appPanel{border-radius:16px;border-top:3px solid var(--tone);overflow:hidden}.appHead{display:flex;align-items:center;justify-content:space-between;padding:13px 14px;border-bottom:1px solid #ffffff10}.appHead>div{display:flex;align-items:center;gap:8px}.appHead h3{margin:0;font-size:15px}.appHead>div>span{font-size:19px}.empty{padding:25px;text-align:center;color:#94aac0;font-size:12px}.userList{padding:4px 12px 12px;max-height:470px;overflow:auto}.userRow{display:grid;grid-template-columns:minmax(0,1fr) 130px 130px;gap:8px;align-items:end;padding:10px 2px;border-bottom:1px solid #ffffff0d}.userRow.two{grid-template-columns:minmax(0,1fr) 135px}.userRow label{font-size:11px;color:#9db4c9;font-weight:900}.userRow select{display:block;width:100%;height:38px;margin-top:5px;font-size:13px}.who{display:flex;align-items:center;gap:8px;min-width:0}.who>div{width:32px;height:32px;flex:0 0 32px;border-radius:50%;display:grid;place-items:center;background:#ffffff10;font-size:10px;font-weight:900}.who p{margin:0;min-width:0}.who b,.who span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.who b{font-size:13px}.who span{font-size:10px;color:#91a7bc;margin-top:4px}@media(max-width:1050px){.connections{grid-template-columns:1fr}.connectBox{grid-template-columns:1fr 1fr 1fr auto}.apps{grid-template-columns:1fr}.roles{grid-template-columns:repeat(2,1fr)}}@media(max-width:700px){.page{padding:20px 10px 45px}.top{align-items:flex-start;flex-direction:column}.top h1{font-size:27px}.statusGrid{grid-template-columns:1fr}.connectBox{grid-template-columns:1fr}.connections{gap:8px}.identity{grid-template-columns:1fr}.roles{grid-template-columns:1fr 1fr}.legend{gap:10px}.userRow,.userRow.two{grid-template-columns:1fr 1fr}.who{grid-column:1/-1}.createPanel{padding:14px}}@media(max-width:430px){.roles{grid-template-columns:1fr}.userRow,.userRow.two{grid-template-columns:1fr}.who{grid-column:auto}}
`;
